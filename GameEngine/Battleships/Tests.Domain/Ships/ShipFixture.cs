...
namespace Tests.Domain.Ships
{
    ...
    [Test]
        public void GivenShip_WhenConstructing_AddsCorrectAmountOfShipSegments()
        {
            ...
            Ship ship = new ShipStub(player, segmentCount, new WeaponStub(player, 1));
        ...
        {
            Assert.Throws<ArgumentException>(() => new ShipStub(player, segmentCount, new WeaponStub(player, 1)));
        }

        [Test]
        public void GivenCarrier_WhenConstructing_CreatesFiveSegements()
        {
            var carrier = new Carrier(player, ShipType.Carrier, new WeaponStub(player, 0));
        ...
        {
            var battleship = new Battleship(player, ShipType.Battleship, new WeaponStub(player, 0));
        ...
        {
            var cruiser = new Cruiser(player, ShipType.Cruiser, new WeaponStub(player, 0));
        ...
        {
            var submarine = new Submarine(player, ShipType.Submarine, new WeaponStub(player, 0));
        ...
        {
            var destroyer = new Destroyer(player, ShipType.Destroyer, new WeaponStub(player, 0));
        ...
        {
            var ship = new ShipStub(player, 1, new WeaponStub(player, 1));
            const int width = 5;
            const int height = 5;
            var map = new PlayerMap(width, height, this.player);
            var coordinate = new Point(0, 0);
        ...
        {
            var ship = new ShipStub(player, 2, new WeaponStub(player, 1));
            const int width = 5;
            const int height = 5;
            var map = new PlayerMap(width, height, this.player);
            var coordinate = new Point(0, 0);
        ...
        {
            var ship = new ShipStub(player, 4, new WeaponStub(player, 1));
            const int width = 5;
            const int height = 5;
            var map = new PlayerMap(width, height, this.player);
            var coordinate = new Point(0, 0);
