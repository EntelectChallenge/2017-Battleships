...
namespace GameEngine.Common
{
    ...
    public abstract class Player : IDisposable
    {
        ...
        /// </summary>
        public BattleshipPlayer BattleshipPlayer { get; private set; }
        /// <summary>
        ...
        /// </summary>
        /// <param name="battleshipPlayer">The registered player entity</param>
        public void PlayerRegistered(BattleshipPlayer battleshipPlayer)
        {
        ...
        /// <summary>
        /// Notifies the player that first round has failed and he will have to resubmit the place ship file
        /// </summary>
        /// <param name="gameMap">The current game map</param>
        public abstract void FirstRoundFailed(GameMap gameMap);
